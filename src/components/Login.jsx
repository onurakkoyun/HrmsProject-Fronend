                ...
                <div>
                  <div className="flex justify-between">
                    ...
                    <div>
                      <Link
                        to="/password/reset"
                        className="font-mulish font-bold text-sm text-indigo-600 grid justify-items-start"
                      >
                        Forgot password?
                      </Link>
                    </div>
                  ...
                  <div className="relative max-w-xl mt-2">
                    <span
                      className="text-gray-400 absolute right-3 inset-y-0 my-auto active:text-gray-600 hover:cursor-pointer"
