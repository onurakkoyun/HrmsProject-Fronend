      ...
      <section className="mt-6 lg:mt-2 overflow-hidden bg-gray-50 sm:grid sm:grid-cols-2 sm:items-center">
        <div className="p-4 md:p-6 lg:px-8 lg:py-10">
          <div className="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
            ...
            <p className="text-left text-xl font-bold md:text-md md:font-light">
              Don't miss out on this opportunity to shape your future!
            </p>

            <div className="mt-3 mr-6 md:mt-6">
              <a
        ...
        <div className="p-5">
          <img
            alt="Violin"
            src={CtaPhoto}
            className="object-cover sm:h-[calc(100%_-_2rem)] sm:self-end sm:rounded-ss-[30px] md:h-[calc(100%_-_6rem)] md:rounded-ss-[80px]"
          />
        </div>
      </section>

      <section className="bg-gray-50">
        <div className="mx-auto max-w-screen-2xl px-4 py-4 sm:px-3 lg:px-4 lg:py-6">
          <div className="md:flex md:items-end md:justify-between">
            <div className="max-w-2xl">
              <h2 className="text-left text-4xl font-mulish font-[800] tracking-tight text-gray-900 sm:text-6xl">
                Read reliable reviews from those who choose us.
              </h2>

              <p className="mt-3 max-w-xl leading-relaxed text-xl text-left text-gray-700">
            ...
            <a
              href="/"
              className="inline-flex shrink-0 items-center gap-2 rounded-full border border-red-600 px-5 py-3 text-red-600 transition hover:bg-red-600 hover:text-white md:mt-0"
            >
              <span className="font-mulish font-[700]"> Read all reviews </span>
          ...
          <div className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-3">
            <blockquote className="flex w-full h-full flex-col justify-between bg-white p-2 shadow-sm sm:p-4">
              <div>
                <div className="flex gap-0.5 text-[#1dc423]">
                  <svg
                    className="h-4 w-4"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                <div className="mt-4">
                  <p className="text-left text-2xl font-mulish font-[800] text-red-600 sm:text-4xl">
                    Stayin' Alive
                  </p>

                  <p className="mt-4 leading-relaxed font-mulish text-left text-lg text-gray-700">
              ...
              <footer className="mt-4 text-left text-md font-bold text-gray-700 sm:mt-6">
                &mdash; Michael Scott
              </footer>
            </blockquote>

            <blockquote className="flex h-full flex-col justify-between bg-white p-2 shadow-sm sm:p-4">
              <div>
                <div className="flex gap-0.5 text-[#1dc423]">
                  <svg
                    className="h-4 w-4"
        ...
        <div className="py-4">
          <div className="max-w-screen-xl mx-auto px-4 md:px-8">
            <div className="mb-6 max-w-xl mx-auto text-center">
              <span className="mb-2 text-gray-800 text-3xl font-mulish font-semibold sm:text-4xl">
            ...
            <div className="mt-12 flex justify-center">
              <ul className="inline-grid gap-x-8 gap-y-6 md:gap-x-9 grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                {/* LOGO 1 */}
                <li className="hover:animate-pulse hover:cursor-pointer">
                  <a href="https://jobs.dropbox.com/all-jobs" target="_blank">
                    <svg
                      className="w-8 my-auto lg:w-10"
                      viewBox="0 0 163 48"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                ...
                {/* LOGO 2 */}
                <li className="hover:animate-pulse hover:cursor-pointer">
                  <a href="https://www.notion.so/careers" target="_blank">
                    <svg
                      className="w-8 my-auto lg:w-10"
                      viewBox="0 0 129 48"
                      fill="none"
                ...
                <li className="hover:animate-pulse hover:cursor-pointer">
                  <a
                    href="https://githubinc.jibeapply.com/jobs"
                    target="_blank"
                  >
                    <svg
                      className="w-8 my-auto lg:w-10"
                ...
                <li className="hover:animate-pulse hover:cursor-pointer">
                  <a
                    href="https://jobs.careers.microsoft.com/global/en/search?l=en_us&pg=1&pgSz=20&o=Relevance&flt=true&ref=cms"
                    target="_blank"
                  >
                    <svg
                      className="w-8 my-auto lg:w-10"
                ...
                {/* LOGO 5 */}
                <li className="hover:animate-pulse hover:cursor-pointer">
                  <a href="https://linear.app/careers#join-us" target="_blank">
                    <svg
                      className="w-8 my-auto lg:w-10"
                      viewBox="0 0 148 48"
                      fill="none"
                ...
                <li className="hover:animate-pulse hover:cursor-pointer">
                  <a
                    href="https://flows.beamery.eu/canva/canvalife-talent-community"
                    target="_blank"
                  >
                    <svg
                      className="w-8 my-auto lg:w-10"
                ...
                {/* LOGO 7 */}
                <li className="hover:animate-pulse hover:cursor-pointer">
                  <a href="https://careers.zoom.us/jobs/search" target="_blank">
                    <svg
                      className="w-8 my-auto lg:w-10"
                      viewBox="0 0 98 48"
                      fill="none"
                ...
                {/* LOGO 8 */}
                <li className="hover:animate-pulse hover:cursor-pointer">
                  <a href="https://slack.com/careers" target="_blank">
                    <svg
                      className="w-8 my-auto lg:w-10"
                      viewBox="0 0 121 48"
                      fill="none"
